...
冒頭でも少し書きましたが、2015年から税制が改正され、寄付する先の自治体の数が５つ以下であれば確定申告不要でふるさと納税を利用できる<strong>「ワンストップ特例制度」</strong>がスタートしました。６回以上のふるさと納税を行ったとしても、寄付先の自治体数が５以下であればこの特例は適用されます。
